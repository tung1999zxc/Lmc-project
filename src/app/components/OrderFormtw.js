...
const handlePageNameChange = (value) => {
  ...
  const tinhTrangGHOptions = ["ĐÃ GỬI HÀNG","ĐÃ LÊN ĐƠN", "GIAO THÀNH CÔNG","VẮNG MẶT","HẸN GIAO LẠI","ĐÃ GỬI VÀO CỬA HÀNG","HOÀN"];
    ...
    >
      ...
      {currentUser.position === "kho1" || currentUser.position === "kho2" ? (
        ...
        <Input type="number" />
               ...
               <Form.Item label="ngày done" name="orderDate6" hidden>
        <Input type="number" />
      </Form.Item>
            ...
            <Form.Item label="Ngày xóa ds" name="orderDate6" hidden={true} >
                             <Input type="number" />
                            </Form.Item>
