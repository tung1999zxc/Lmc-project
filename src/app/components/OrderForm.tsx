...
// Định nghĩa kiểu dữ liệu của các trường trong form (giá trị nội bộ, DatePicker sử dụng dayjs.Dayjs)
export interface OrderFormValues {
  orderDate?: dayjs.Dayjs | null;
  shippingDate1?: dayjs.Dayjs | null;
  shippingDate2?: dayjs.Dayjs | null;
...
// Định nghĩa kiểu dữ liệu gửi lên (với các ngày là chuỗi)
...
// Interface cho props của OrderForm
interface OrderFormProps {
  visible: boolean;
  onCancel: () => void;
  onSubmit: (values: OrderFormSubmitValues) => void;
  initialValues?: OrderFormSubmitValues;
}
...
const OrderForm: React.FC<OrderFormProps> = ({
  ...
  const onFinish = (values: OrderFormValues) => {
    const submitValues: OrderFormSubmitValues = {
      ...values,
      ...
      {isEmployee1 ? (
        <>
          <Form form={form} layout="vertical" onFinish={onFinish}>
            ...
            <Form.Item label="DOANH SỐ" name="profit" hidden={isEmployee1}>
              <Input type="number" />
            </Form.Item>
