...
const handlePageNameChange = (value) => {
  ...
  const tinhTrangGHOptions = ["ĐÃ GỬI HÀNG","ĐÃ LÊN ĐƠN", "GIAO THÀNH CÔNG","VẮNG MẶT","HẸN GIAO LẠI","CUỘC ĐIỀU TRA","HOÀN"];
        ...
        <>
          <Form form={form} layout="vertical" onFinish={onFinish}>
            ...
            <Form.Item label="DOANH SỐ" name="revenue" hidden={true}>
             ...
             <Form.Item label="Ngày xóa ds" name="orderDate6"  hidden>
                             <Input type="number" />
                            </Form.Item>
      ...
      <Option key={employee} value={employee}>
        {employee}
            ...
            <Form.Item style={{ marginTop: 24, textAlign: "right" }}>
              ...
              {(currentUser.position_team === "sale" || initialValues||currentUser.name ==="Phi Navy") && (
                <Button type="primary" htmlType="submit">
                  {initialValues ? "Cập nhật" : "Thêm mới"}
                </Button>
              )}
