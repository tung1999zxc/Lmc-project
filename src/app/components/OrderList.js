...
const OrderList = () => {
  ...
  const columns = [
          ...
          >
            ...
            {count > 1 && (
              <span
                ...
                style={{ backgroundColor: getColorForCustomer(customerName) }}
              >
                {count}
              </span>
            )}
    ...
    },
    {
      ...
      render: (text) => {
        ...
        return (
          <span
            className={`order-status-tag ${isSuccess ? "success" : "warning"}`}
          >
            {text}
          </span>
        );
      ...
      ? [
          {
            ...
            key: "salexuly",
            sorter: (a, b) =>
              (a.salexuly || "").localeCompare(b.salexuly || ""),
          },
        ]
      : []),
    // {
    ...
    },
    {
      ...
      sorter: (a, b) => {
        ...
        return (
          dayjs(a.shippingDate1).valueOf() - dayjs(b.shippingDate1).valueOf()
        );
      },
      render: (text) => {
        if (!text) return "N/A";
    ...
    },
    {
      ...
      sorter: (a, b) => {
        ...
        return (
          dayjs(a.shippingDate2).valueOf() - dayjs(b.shippingDate2).valueOf()
        );
      },
      render: (text) => {
        if (!text) return "N/A";
    ...
    },
    {
      ...
      key: "processStatus",
      sorter: (a, b) =>
        (a.processStatus || "").localeCompare(b.processStatus || ""),
    },
  ];
  ...
  const columnsMKT = [
    ...
    },
    {
      ...
      width: 20,
      sorter: (a, b) =>
        (parseFloat(a.profitmkt) || 0) - (parseFloat(b.profitmkt) || 0),
    },
    {
      title: "ĐƠN",
      width: 100,
...

    {
      ...
      render: (text) => (
        <Tag
          color={text === "ĐÃ THANH TOÁN" ? "green" : "red"}
          className="customer-history-tag"
        >
          {text}
        </Tag>
      ),
  ...
  const columnsKHO = [
    ...
    },
    {
      ...
      render: (text) => (
        <Tag
          color={text === "GIAO THÀNH CÔNG" ? "blue" : "orange"}
          className="customer-history-tag"
        >
          {text}
        </Tag>
            ...
            <Col xs={24} md={8} lg={7}>
              <div className="filter-group">
                ...
                {currentUser.position_team === "kho" ? (
                  ...
                  <Select
                    ...
                    options={[
                      ...
                      {
                        value: "donechuaguichuagui",
                        label: "Done + Chưa Gửi Hàng",
                      },
                ...
                {(currentUser.position === "leadSALE" ||
                  ...
                  <div className="check-customer-box" style={{ marginTop: 8 }}>
                    <Input
                      placeholder="Nhập STT..."
                      allowClear
                      id="check-lichsu-input"
                      className="check-customer-input"
                      onPressEnter={(e) =>
                        handleSearchCustomerModalLS(e.target.value.trim())
                      }
                    />
                    <Button
                      type="primary"
